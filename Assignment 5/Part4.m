...
stim_amp = -10 ;
stim_amp2 = -10;
secondDuration = 3; % (7,11)

stim_start = stimdelay ;
stim_end = stimdelay + stimdur ; % stim_end = 6
secondImpulse_start = stim_end + secondDuration;
secondImpulse_end = secondImpulse_start + 1;
...
simints = 5 ; % No. of intervals

intervals(1,:) = [0,stim_start] ;
intervals(2,:) = [stim_start,stim_end] ;
intervals(3,:) = [stim_end, secondImpulse_start];
intervals(4,:) = [secondImpulse_start, secondImpulse_end];
intervals(5,:) = [secondImpulse_end,tend] ;
